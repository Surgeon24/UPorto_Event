...
insert into autherised_user (user_id, name, surname, nickname, password, email, date_registered, last_Seen, birth_date, url, status, is_admin, photo_path) values (12, 'Mame', 'Portch', 'mportchb', 'liLZ6WRhYM', 'mportchb@amazon.de', '10/6/2022', '10/30/2022', '1/29/2011', 'profile page url', 'dolor morbi vel lectus in quam fringilla rhoncus mauris enim leo rhoncus sed vestibulum', false, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABGdBTUEAAK/HwSURBVDjLpZM9a1RBFIafM/fevfcmC7uQjWEjUZKAYBHEVEb/gIWFjVVSWEj6gI0/wt8gprPQykIsTP5BQLAIhBVBzRf52Gw22bk7c8YiZslugggZppuZ55z3nfdICIHrrBhg+ePaa1WZPyk0s+6KWwM1');
insert into autherised_user (user_id, name, surname, nickname, password, email, date_registered, last_Seen, birth_date, url, status, is_admin, photo_path) values (13, 'Hobey', 'Passler', 'hpasslerc', 'APtUOoadJMi', 'hpasslerc@bloglines.com', '10/6/2022', '10/16/2022', '9/1/1998', 'profile page url', 'pellentesque quisque porta volutpat erat quisque erat eros viverra eget congue', false, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABGdBTUEAAK/JhSURBVDjLdZPda85hGMc/v+f5Pc8e2wE2QtiMyZh5K4RSpCkHxJnkSElOxJFy4kDyF3DopR15yUst2pRpJw4cSJLETCTb0mxre57f775eHPyevdBcdXfV3X19ru/36rojd+fwuZtt7n7PYQRnt+O4A++/////+/++iWE7x71UVj//bxZ+4+=');
...
insert into autherised_user (user_id, name, surname, nickname, password, email, date_registered, last_Seen, birth_date, url, status, is_admin, photo_path) values (16, 'Truda', 'Daouse', 'tdaousef', 'BDxHfMRw', 'tdaousef@usatoday.com', '10/5/2022', '10/21/2022', '7/17/1999', 'profile page url', 'elementum ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas', false, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABGdBTUEAAK/KxSURBVDjLdZNfSFNRHMc3FVNEBTWFFH0wTAVf9NEeiiLNh+ohKZIykKSHegssJXqZVFbiKsOUNAkhMu7wz8zgqjk3LndbOnVuorPdbboZsc0/zKs4+XbOdU4jPfC9v3PO73w/53cu58gAyKhIk+/++/YAAAAABJRU5ErkJggg==');
...
insert into autherised_user (user_id, name, surname, nickname, password, email, date_registered, last_Seen, birth_date, url, status, is_admin, photo_path) values (18, 'Griff', 'Vaszoly', 'gvaszolyh', 'zZbKF3ouMf5k', 'gvaszolyh@blogtalkradio.com', '10/7/2022', '10/15/2022', '3/6/1970', 'profile page url', 'eu orci mauris lacinia sapien quis libero nullam sit amet turpis elementum ligula vehicula consequat morbi a ipsum integer a', false, 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABGdBTUEAAK/BIG/KROKHVOPF8X5rCeIv1BuMMK1GOI02nyZsiH769DVcBYXRsrWzGeocTz1x2ht0VtXxKj/Jl+v1y0dCg/vVMl4daXKg');
